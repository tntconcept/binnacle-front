...
export function getActionFromKey(key: string, menuOpen: boolean): MenuActions | undefined {
...
export function isScrollable(element: RefObject<HTMLElement>): boolean {
  return element.current ? element.current.clientHeight < element.current.scrollHeight : false;
}

// ensure given child element is within the parent's visible scroll area
export function maintainScrollVisibility(activeElement: RefObject<HTMLElement>, scrollParent: RefObject<HTMLElement>) {
