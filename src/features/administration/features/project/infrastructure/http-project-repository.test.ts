...
describe('HttpProjectRepository', () => {
  ...
  it('should call httpclient post with the correct parameters when block a project', async () => {
    const { httpClient, projectRepository } = setup()
  ...
  it('should call httpclient post with the correct parameters when unblock a project', async () => {
    const { httpClient, projectRepository } = setup()
